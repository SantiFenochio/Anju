...
export function HomePage() {
  ...
  return (
    <div>
      <section className="relative overflow-hidden bg-gradient-to-b from-crema via-[#fcf7f0] to-white">
        <div className="absolute inset-0 pointer-events-none wood-grain opacity-[0.08]" aria-hidden="true" />
        <div className="relative max-w-6xl mx-auto px-4 py-14 sm:py-16 md:py-20 grid gap-12 lg:gap-16 md:grid-cols-2 items-center">
          <div className="relative max-w-2xl">
            ...
            <div className="relative">
              <p className="text-xs font-semibold tracking-[0.2em] uppercase text-oliva mb-4">
                Carpintería familiar · Buenos Aires
              </p>
              <h1 className="heading-h1 max-w-2xl tracking-[-0.01em]">
                Carpintería a medida en Villa Ballester para muebles de madera durables
              </h1>
              <p className="mt-6 text-[1.02rem] text-neutral-700 max-w-xl leading-relaxed">
              ...
              <div className="mt-7 flex flex-wrap gap-2.5">
                <span className="inline-flex items-center rounded-full border border-oliva/25 bg-oliva/10 px-3.5 py-1.5 text-[11px] font-semibold text-oliva">
              ...
              <div className="mt-8 flex flex-wrap gap-3.5">
                <Link
                  to="/catalogo"
                  className="btn-primary h-11 px-6 text-sm sm:text-[0.95rem]"
                >
                  Ver catálogo de muebles
                </Link>
                <Link
                  to="/muebles-a-medida"
                  className="btn-secondary h-11 px-6 text-sm sm:text-[0.95rem] bg-white/90 shadow-md hover:shadow-lg"
                >
              ...
              <div
                ref={heroBadgeRef}
                className="mt-6 inline-flex items-center gap-2 rounded-full border border-madera/20 bg-white/90 px-3.5 py-1.5 text-[11px] text-madera shadow-sm opacity-0"
              >
              ...
              <div className="mt-4 inline-flex items-start gap-2 text-xs text-neutral-700 max-w-2xl">
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3.5 text-sm text-neutral-700">
                <div className="rounded-2xl border border-madera/15 bg-white/90 px-4 py-4 shadow-[0_12px_28px_rgba(139,90,43,0.08)] min-h-[122px]">
                  <p className="text-lg font-semibold text-neutral-900">+30 años</p>
                  <p className="mt-1">de experiencia en carpintería fina</p>
                </div>
                <div className="rounded-2xl border border-madera/15 bg-white/90 px-4 py-4 shadow-[0_12px_28px_rgba(139,90,43,0.08)] min-h-[122px]">
                  <p className="text-lg font-semibold text-neutral-900">Madera maciza</p>
          ...
          <div className="relative flex justify-center md:justify-end">
            ...
            <div className="relative w-full max-w-lg md:max-w-xl lg:max-w-2xl aspect-[4/5] rounded-[2rem] overflow-hidden shadow-[0_24px_56px_rgba(139,90,43,0.2)] border border-madera/20 transform-gpu transition-transform bg-[linear-gradient(135deg,#8B5A2B,#F5F0E8)] ring-1 ring-white/45">
              <img
                src={heroImage}
            ...
            <div className="absolute -bottom-4 right-2 sm:-bottom-5 sm:-right-3 bg-white/95 shadow-[0_14px_34px_rgba(139,90,43,0.16)] rounded-xl px-4 py-3.5 text-xs max-w-[238px] border border-madera/10 scroll-fade opacity-0">
      ...
      <section className="relative max-w-6xl mx-auto px-4 py-14 sm:py-16">
        <div className="absolute inset-0 pointer-events-none wood-grain opacity-[0.06]" aria-hidden="true" />
        <div className="relative rounded-[1.75rem] border border-madera/12 bg-white/70 px-5 py-7 sm:px-7 sm:py-9 md:px-8">
          ...
          <div className="relative">
            <div className="hidden md:block absolute left-0 right-0 top-9 h-px bg-madera/20" aria-hidden="true" />
            <div className="grid gap-4 md:grid-cols-5">
              {FAMILY_TIMELINE.map((item) => (
                <article
                  key={item.year}
                  className="group rounded-2xl border border-madera/15 bg-white/95 shadow-[0_10px_26px_rgba(139,90,43,0.08)] p-5 min-h-[196px] scroll-fade opacity-0 transition-all hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(139,90,43,0.14)]"
                >
      ...
      <section className="max-w-6xl mx-auto px-4 py-14 sm:py-16">
        <div className="rounded-[1.75rem] border border-madera/12 bg-gradient-to-b from-white to-crema/35 px-5 py-7 sm:px-7 sm:py-9 md:px-8">
          <div className="flex flex-col gap-2">
          <p className="text-xs font-semibold tracking-[0.2em] uppercase text-oliva">
            Confían en nosotros
          </p>
        ...
        <div className="mt-7 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {TRUSTED_LOGOS.map((logo) => (
            <div
              key={logo}
              className="group rounded-2xl border border-madera/10 bg-white/95 shadow-[0_8px_22px_rgba(139,90,43,0.08)] card-pad min-h-[98px] flex items-center justify-center text-center text-xs sm:text-sm font-semibold text-neutral-500 tracking-wide uppercase transition-all scroll-fade opacity-0 hover:border-oliva/30 hover:text-neutral-700 hover:shadow-[0_14px_28px_rgba(139,90,43,0.14)]"
            >
              {logo}
            </div>
          ))}
      ...
      <section className="max-w-6xl mx-auto px-4 py-14 sm:py-16">
        <div className="rounded-[1.75rem] border border-madera/12 bg-white/80 px-5 py-7 sm:px-7 sm:py-9 md:px-8 space-y-8">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5">
            <div>
            <h2 className="heading-h2 tracking-[-0.01em]">
              Muebles pensados para uso diario intenso
            </h2>
            <p className="mt-2.5 text-[1.02rem] text-neutral-700 max-w-2xl leading-relaxed">
          ...
          <button
            ...
            className="btn-secondary h-11 px-6 text-sm sm:text-[0.95rem] self-start md:self-auto"
          >
            Presupuesto gratis
          </button>
        </div>
        <div className="grid gap-6 md:grid-cols-3">
          <div className="relative group rounded-2xl bg-white shadow-[0_10px_26px_rgba(139,90,43,0.08)] border border-madera/10 overflow-hidden transform-gpu transition-all hover:-translate-y-0.5 hover:shadow-[0_18px_38px_rgba(139,90,43,0.14)] scroll-fade opacity-0">
            <img
            ...
            <div
              ...
              aria-hidden="true"
            />
            <div className="card-pad min-h-[132px]">
